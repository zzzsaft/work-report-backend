    ...
    const findMany = vi.fn().mockResolvedValue([
      {
        ...
        workOrder: { orderNo: "WO-001", productCode: "CP-001", productName: "产品A" },
        part: { partNo: "01", partCode: "P-001", partName: "零件A" },
        operationPool: { operationCode: "OP-001", operationName: "粗加工", estimatedHours: 2, operationNote: "切削后去毛刺并测量尺寸。", ylpartnum: "YL-001", yldescription: "45号钢", mfgcomment: "调质处理", cpNum: "CP-001", cpDes: "原产品A" },
        workerName: "张师傅",
        status: "completed",
