...
export const serializeProduct = (order: WorkOrder & { operationPools?: OperationPool[] }) => ({
  id: order.id,
...
export const serializePart = (part: WorkOrderPart & { operationPools?: OperationPool[] }) => ({
  id: part.id,
...
export const serializeOperation = (
  operation: OperationPool & { workOrder: WorkOrder; part: WorkOrderPart }
) => ({
  id: operation.id,
